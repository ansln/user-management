...
export default function LoginComponent() {
    ...
    async function handleSubmit(e) {
        ...
        if (userName == "" || userPassword == "") {
            AlertToast('error', 'Username or Password must be filled')
        }else{
            try {
                ...
                redirectUrl ? navigate(redirectUrl) : AlertToast('error', 'Invalid username or password');
    ...
    return (
        <>
            <div className="w-full h-screen flex items-center justify-center bg-slate-100 p-2 font-defaultText">
                <div className="w-80 sm:min-w-[25rem]">
                        ...
                        <div className="p-4 sm:p-7">
                            ...
                            <form id='form' onSubmit={handleSubmit}>
                                ...
                                <div className="flex items-center">
                                    <div className="flex">
                                    <input id="remember-me" name="remember-me" type="checkbox" className="shrink-0 mt-0.5 border border-gray-200 rounded text-blue-600 focus:ring-blue-500" />
                                    </div>
                                    <div className="ms-3">
